...
static struct Option optsCheats[] = {
    ...
    DEF_OPT_TOGGLE( optsCheatsStr[9], &Cheats.InfiniteFallHeight ),
    DEF_OPT_TOGGLE( optsCheatsStr[10], &Cheats.SpecialTripleJump ),
};
...
static struct SubMenu menuGameplay = DEF_SUBMENU( menuStr[7], optsGameplay );
...
static struct Option optsMain[] = {
    ...
    DEF_OPT_SUBMENU( menuStr[7], &menuGameplay ),
